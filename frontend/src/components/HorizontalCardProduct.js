                    ...
                    loadingList.map((product, index) => {
                        return(
                            <div className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                                ...
                                <div className='bg-slate-200 h-full p-4 min-w-[120px] md:min-w-[145px] max-w-[120px] md:max-w-[145px] items-center justify-center flex animate-pulse'>
                    ...
                    data.map((product, index) => {
                        return(
                            <Link to={"product/"+product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                                ...
                                <div className='bg-slate-200 h-full p-4 min-w-[120px] md:min-w-[145px] max-w-[120px] md:max-w-[145px] items-center justify-center flex'>
                                    <img src={product.productImage[0]} className='object-scale-down h-full hover:scale-110 mix-blend-multiply'/>
                                </div>
